...
namespace ConsoleApplication46
{
    class Student:Osoba
    {
        ...
        {
            return String.Format("Imię i nazwisko: {0} {1}", imie, nazwisko) + Environment.NewLine + String.Format("Rok: {0}", rok) + Environment.NewLine + String.Format("Numer grupy: {0}", numerGrupy) + Environment.NewLine + String.Format("Numer albumu: {0}", numerAlbumu);
        }
    }
}
